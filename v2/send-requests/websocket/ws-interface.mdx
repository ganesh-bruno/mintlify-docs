...
![WebSocket Interface](/v2/images/screenshots/send-request/ws/websocket-interface.webp)
...
![Send WebSocket Request](/v2/images/screenshots/send-request/ws/send-ws-req.webp)
