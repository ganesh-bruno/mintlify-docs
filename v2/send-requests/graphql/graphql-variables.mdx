...
2. **Define Variables**:
  ...
  ![query-graphql](/v2/images/screenshots/send-request/graphql/adding-var-graphql.webp)
...
![query-graphql](/v2/images/screenshots/send-request/graphql/using-var-in-graphql.webp)
