...
![create-graphql-request](/v2/images/screenshots/send-request/graphql/create-graphql-request.webp)
...
![query-graphql](/v2/images/screenshots/send-request/graphql/graphql-req-query.webp)
