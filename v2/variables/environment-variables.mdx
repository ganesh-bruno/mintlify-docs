...
![No-Environment](/v2/images/screenshots/variables/collection-environment.webp)

- Add your variable name and value for the specific environment.
- Save your changes.

![Environment Variables location](/v2/images/screenshots/variables/environment-variables.webp)
