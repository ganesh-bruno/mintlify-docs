...
![Collection Variables](/v2/images/screenshots/variables/collection-variables.webp)

## Using a Collection Variable
You can use the `{{varName}}` syntax to use a collection variable in a request.

![Collection Variables Usage](/v2/images/screenshots/variables/collection-variables-usage.webp)
