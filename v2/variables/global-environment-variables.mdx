...
![No-Environment](/v2/images/screenshots/variables/no-environment.webp)
...
![global-environment](/v2/images/screenshots/variables/global-environment.webp)

4. Enter a name for your environment and click **Create**.

![Environment Variables location](/v2/images/screenshots/variables/select-env-name.webp)

5. Add a variable by specifying the **Name** and **Value**.

![Environment Variables location](/v2/images/screenshots/variables/create-env-key-value-pair.webp)
...
![Environment Variables location](/v2/images/screenshots/variables/env-action.webp)
