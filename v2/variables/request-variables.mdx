...
![Request Variables](/v2/images/screenshots/variables/request-variables.webp)

## Using a Request Variable
You can use the `{{varName}}` syntax to use a request variable in a request.

![Request Variables Usage](/v2/images/screenshots/variables/request-variables-usage.webp)
