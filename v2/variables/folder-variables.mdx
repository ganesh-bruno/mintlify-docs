...
![Folder Variables](/v2/images/screenshots/variables/folder-variables.webp)

## Using a Folder Variable
You can use the `{{varName}}` syntax to use a folder variable in a request.

![Folder Variables Usage](/v2/images/screenshots/variables/folder-variables-usage.webp)
