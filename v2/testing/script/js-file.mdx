...
![select-script](/v2/images/screenshots/create-js-file/new-script.webp)

3. Enter name and select **Create**

![create-script](/v2/images/screenshots/create-js-file/sample-js.webp)
...
![import-script](/v2/images/screenshots/create-js-file/js-file.webp)

![import-script](/v2/images/screenshots/create-js-file/import-js-file.webp)
