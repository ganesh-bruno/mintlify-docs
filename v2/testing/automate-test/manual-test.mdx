...
![select-run.webp](/v2/images/screenshots/testing/1-select-run.webp)

3. Click **Run Collection** to initiate the test.

![click-runner.webp](/v2/images/screenshots/testing/2-click-runner.webp)

4. Once the test run is complete, a test report will be automatically generated.

![generate-test-report.webp](/v2/images/screenshots/testing/3-generate-test-report.webp)
...
![details-test-reports.webp](/v2/images/screenshots/testing/4-details-test-reports.webp)
...
![Add Tags to Requests](/v2/images/screenshots/collection-runner/1-add-tags.webp)
...
![Run Collection with Tags](/v2/images/screenshots/collection-runner/2-run-collection-tags.webp)
...
![Reorder Requests](/v2/images/screenshots/testing/reorder-req.webp)
...
![test-web-view.webp](/v2/images/screenshots/testing/test-web-view.webp)
