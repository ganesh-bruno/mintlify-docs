...
![bitbucket-create-repository](/v2/images/screenshots/git-integration/bitbucket-gitlab/bit-create-project.webp)

Once you create a repository, click on the **Clone** button and copy the URL, which looks similar to:

![bitbucket-clone-repository](/v2/images/screenshots/git-integration/bitbucket-gitlab/bit-clone-repo.webp)
...
![bitbucket-add-ssh-key](/v2/images/screenshots/git-integration/bitbucket-gitlab/bit-add-ssh.webp)
...
![bruno-git-operations](/v2/images/screenshots/git-integration/bitbucket-gitlab/bruno-git-operations.webp) 
