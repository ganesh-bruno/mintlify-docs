...
![Initialize Git](/v2/images/screenshots/git-integration/git-gui/1-init-git.webp)

4. Click the **Initialize** button to set up your collection with Git.

![Click Init Button](/v2/images/screenshots/git-integration/git-gui/2-click-init-button.webp)
...
![Add Remote Option](/v2/images/screenshots/git-integration/git-gui/5-add-remote-option.webp)

5. Click on **Add Remote** button.
6. Enter **Remote Name** and **URL** (Https or SSH) and click on save.


![Add Remote Dialog Box](/v2/images/screenshots/git-integration/git-gui/6-add-remote-dialogbox.webp)
...
![Stage Changes](/v2/images/screenshots/git-integration/git-gui/3-stage-changes.webp)

4. Click on **Commit Changes** button.
5. Write a Commit Message and click **Commit**.

![Commit Changes](/v2/images/screenshots/git-integration/git-gui/4-commit-changes.webp)
...
![Push Pull](/v2/images/screenshots/git-integration/git-gui/8-push-pull.webp)
...
![Create Branch](/v2/images/screenshots/git-integration/git-gui/7-create-branch.webp)
...
![Create Branch](/v2/images/screenshots/git-integration/git-gui/9-branch-checkout.webp)
