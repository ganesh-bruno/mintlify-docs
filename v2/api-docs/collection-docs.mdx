...
![collection-settings](/v2/images/screenshots/send-request/api-docs/collection-settings-docs.webp)

3. Click on the **Edit** icon on the right-hand side.

![collection-preview](/v2/images/screenshots/send-request/api-docs/collection-preview.webp)

4. Click the **Save** button to view the formatted output.  

![collection-preview](/v2/images/screenshots/send-request/api-docs/save-collection-docs.webp)

5. Formatted Preview for Collection Documentation.

![collection-preview](/v2/images/screenshots/send-request/api-docs/formatted-output.webp)