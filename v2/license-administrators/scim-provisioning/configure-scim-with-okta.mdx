...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-1.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />

2. Select **SWA - Secure Web Authentication** and click **Next**

<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-2.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-3.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-5.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-7.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />

4. Click **Test Connector Configuration**. If successful, a **Connector configured successfully** message dialogue appears.

<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-8.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-9.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
...
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-15.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />

<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-16.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />

3. Assigned Users will receive an email with their **License Key**

<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-12.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />

## Deprovision users from Bruno in Okta

1. Under your created Bruno Application, navigate to the **Assignments** tab
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-13.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
2. Remove the desired users or groups, their license key(s) will be deactivated and they will receive an email notification
<img src="/v2/images/screenshots/sso-scim-management/okta/okta-swa-14.webp" alt="License portal login" style={{ width: '800px', marginTop: '1rem', borderRadius: '0.5rem' }} />
