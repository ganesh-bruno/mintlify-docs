...
![Select AWS Secrets Manager Provider](/v2/images/screenshots/secret-variables/aws-secret-manager/4-select-aws-secrets.webp)
...
![AWS Secret Configuration Dialog](/v2/images/screenshots/secret-variables/aws-secret-manager/5-aws-secret-dialog-box.webp)
...
![Fetch Secrets from AWS](/v2/images/screenshots/secret-variables/aws-secret-manager/6-aws-fetch-secrets.webp)
