...
![Select Azure Key Vault Provider](/v2/images/screenshots/secret-variables/azure-key-vault/1-select-azure-vault.webp)
...
![Azure Key Vault Dialog Box](/v2/images/screenshots/secret-variables/azure-key-vault/2-azure-dialog-box.webp)
...
![Test CLI Authentication](/v2/images/screenshots/secret-variables/azure-key-vault/3-test-cli.webp)
