...
![preferences](/v2/images/screenshots/get-started/config/proxy/1-preferences.webp)

3. Navigate to the **Proxy** tab in the sidebar.

![proxy-settings](/v2/images/screenshots/get-started/config/proxy/2-global-proxy.webp)
...
![collection-proxy](/v2/images/screenshots/get-started/config/proxy/3-collection-proxy.webp)
