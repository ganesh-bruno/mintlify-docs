...
![Click Run](/v2/images/screenshots/get-started/bruno-basics/run_collection/run_collection.webp)

or click the Collection Runner icon in the top bar of the application.

![Collection Runner](/v2/images/screenshots/get-started/bruno-basics/run_collection/runnericon.webp)
...
![Collection Runner](/v2/images/screenshots/get-started/bruno-basics/run_collection/runner.webp)
