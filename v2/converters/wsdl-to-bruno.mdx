...
![Import Collection Menu](/v2/images/screenshots/get-started/import-export/import_collection/import_collection_main_menu.webp)

### Step 2: Choose WSDL Option

1. In the Import Collection dialog, select the **WSDL** option

![Import Dialog with WSDL Option](/v2/images/screenshots/get-started/import-export/import_collection/import-modal.webp)
